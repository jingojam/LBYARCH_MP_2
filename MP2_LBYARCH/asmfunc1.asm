...
; ISSUES:
; - the program must round floating point values via (round to nearest ties to even). it currently doesn't (i can't seem to figure it out)
; - the rounding issue can be found at label PROCESS_COL
; - "cvtss2si" instruction is a vital part of float->int conversion, but it rounds up some values (not all)
